...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      <div
        aria-hidden
        className="pointer-events-none absolute -top-24 -right-24 h-96 w-96 rounded-full bg-orange-300/50 blur-3xl"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute top-40 -left-32 h-80 w-80 rounded-full bg-pink-300/50 blur-3xl"
      />
      ...
      <div className="relative mx-auto max-w-6xl px-6 pt-16 pb-24 md:pt-24 md:pb-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              to="/dashboard"
              className="group inline-flex items-center gap-2 rounded-full bg-ink px-7 py-3.5 text-base font-semibold text-cream shadow-pop transition-transform hover:-translate-y-0.5 active:translate-y-1 active:shadow-none"
            >
            ...
            <a
              href="#how-it-works"
              className="inline-flex items-center gap-2 rounded-full border-2 border-ink/15 px-7 py-3.5 text-base font-semibold text-ink transition-colors hover:border-ink/30"
            >
              How it works
            </a>
          </div>
...
function BrowserPreview() {
  return (
    <div className="mx-auto mt-16 max-w-3xl rotate-[-1deg] rounded-2xl border-2 border-ink bg-white p-2 shadow-pop md:mt-20">
      ...
      <div className="grid grid-cols-[auto_1fr] gap-2 overflow-hidden rounded-xl border border-ink/10 bg-cream">
        ...
        <div className="flex flex-col justify-center gap-3 p-6 sm:p-8">
          ...
          <div className="h-16 rounded-lg border border-dashed border-ink/20 bg-white/70 px-3 py-2 text-xs text-ink-faint">
            A one-page site for my dog-walking business, warm and friendly...
          </div>
          <div className="inline-flex w-fit items-center gap-1.5 rounded-full bg-ink px-4 py-2 text-xs font-semibold text-cream">
